...
RegisterNetEvent('ps-adminmenu:server:TeleportToPlayer', function(data, selectedData)
    if not CheckEventPerms(source, 'ps-adminmenu:server:TeleportToPlayer') then return end
...
RegisterNetEvent('ps-adminmenu:server:BringPlayer', function(data, selectedData)
    if not CheckEventPerms(source, 'ps-adminmenu:server:BringPlayer') then return end
