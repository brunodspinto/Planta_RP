...
Config.ClothingRooms = {
    -- Vestiário da Polícia
    {
        job = "police",
        coords = vector4(454.91, -990.89, 30.69, 193.4), -- Coordenadas do balcão
        size = vector3(4, 4, 4),
        rotation = 45,
        usePoly = false,
        points = { ... }
    ...
    -- Vestiário do Hospital (EMS)
    {
        job = "ambulance",
        coords = vector4(306.72, -601.33, 43.29, 154.27),
        size = vector3(3, 3, 3),
        rotation = 154,
        usePoly = false,
    },
    
    -- Podes adicionar Mecânicos, Restaurantes, etc.
}
