local Translations = {
    error = {
        ...
        ["job"] = "Tens de obter o emprego no centro de emprego",
    },
    success = {
    ...
    target = {
        ...
        ["grab_garbage"] = "Pegar no saco do lixo",
        ["dispose_garbage"] = "Despejar saco do lixo",
    },
    menu = {
        ["header"] = "Menu Principal do Lixo",
        ["collect"] = "Receber pagamento",
        ["return_collect"] = "Devolve o camião e recebe o pagamento aqui!",
        ["route"] = "Pedir rota",
        ["request_route"] = "Pedir rota do lixo",
    },
    info = {
